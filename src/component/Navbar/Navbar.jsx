          ...
          <div className="rightAndLeft mt-lg-0 mt-3  d-flex justify-content-between w-100 ">
            <div className=" leftNave links d-flex align-items-center ">
              ...
              <div className="dropdown  ">
                <Link className="btn text-white dropdown-border border-none text-decoration-none dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  platforms
                </Link>
            ...
            <div className="rightNav ">
              ...
              {userData!==null?<li  className='px-2 ms-auto'><span onClick={logOut} className={`  ${style.join}  py-1 px-2 rounded-2 text-decoration-none btn-logOut`}>lougOut</span></li>:<><li className='px-2'><Link className='link text-decoration-none' to='login'>Login</Link></li>
